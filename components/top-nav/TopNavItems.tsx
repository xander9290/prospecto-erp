  ...
  return (
    <Nav className="me-auto">
      ...
      >
        <NavDropdown.Item
          as={Link}
          href="/app/partners?view_mode=list&filter=customer&page=1"
        >
        ...
        <NavDropdown.Item
          as={Link}
          href="/app/partners?view_mode=list&filter=supplier&page=1"
        >
        ...
        <NavDropdown.Item
          as={Link}
          href="/app/partners?view_mode=list&filter=employee&page=1"
        >
